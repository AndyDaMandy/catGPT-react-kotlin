(function (root, factory) {
  ...
  var protoOf = kotlin_kotlin.$_$.j;
  var interfaceMeta = kotlin_kotlin.$_$.g;
  var VOID = kotlin_kotlin.$_$.p;
  var setMetadataFor = kotlin_kotlin.$_$.k;
  var classMeta = kotlin_kotlin.$_$.e;
  var single = kotlin_kotlin.$_$.d;
  //endregion
  ...
  function invoke(_this__u8e3s4, block) {
    this.x3(create(_this__u8e3s4, block));
  }
  ...
  protoOf(ChildrenBuilderImpl).x3 = unaryPlus;
  protoOf(ChildrenBuilderImpl).y3 = unaryPlus_0;
  protoOf(ChildrenBuilderImpl).w3 = child;
  protoOf(ChildrenBuilderImpl).z3 = invoke;
  //endregion
